...
pub fn create_overall_discounts(number_of_passengers: &NumberOfPassengers) -> Option<OverallDiscount> {
...
mod tests {
    ...
    fn test_create_overall_discounts_no_result(#[case] adult: usize, #[case] child: usize) {
        ...
        assert_eq!(None, create_overall_discounts(&number_of_passengers));
    }
    ...
    fn test_create_overall_discounts(#[case] adult: usize, #[case] child: usize, #[case] exp: OverallDiscount) {
        let number_of_passengers = NumberOfPassengers { adult, child };
        assert_eq!(exp, create_overall_discounts(&number_of_passengers).unwrap());
    }
}
